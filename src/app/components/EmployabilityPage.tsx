...
const services = [
  {
    ...
    description:
      "Creamos un CV moderno, con palabras clave, capaz de captar la atención y optimizado para superar filtros automatizados (ATS).",
    features: [
  ...
  },
  {
    ...
    description:
      "Configuramos y potenciamos tu perfil de LinkedIn para destacar tu búsqueda laboral y atraer a los reclutadores.",
    features: [
      "Perfil optimizado",
  ...
  },
  {
    ...
    description:
      "Te enseñaremos a responder las preguntas complejas y cómo enfrentar una entrevista con metodología STAR.",
    features: [
      "Metodología STAR",
...
const plans = [
  {
    name: "Starter",
    price: "$109.990",
    features: ["Redacción de CV", "Optimización de LinkedIn"],
    popular: false,
            ...
            <div>
              ...
              <div className="space-y-4 mb-6">
                <p className="text-xl text-gray-600 leading-relaxed">
                  <span className="text-primary">+1.500 personas</span> ya
                  confiaron en nuestro equipo de psicólogos y expertos en
                  empleabilidad
                </p>
                <p className="text-lg text-gray-600 leading-relaxed">
                  ¿Te has preguntado por qué algunas personas consiguen
                  entrevistas con facilidad? No es suerte: es porque saben
                  comunicar su experiencia, tienen un buen CV, utilizan LinkedIn
                  estratégicamente y saben prepararse para cada entrevista.
                </p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Nuestro método está respaldado por miles de historias de éxito y
                resultados comprobables en el mercado laboral.
              </p>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-purple-50/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              También ofrecemos servicios especializados para empresas que
              buscan optimizar sus procesos de recursos humanos.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Únete a las +1.500 personas que ya confiaron en nuestro método y
              transformaron su búsqueda laboral.
            </p>
