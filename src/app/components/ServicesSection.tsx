...
const mainServices = [
  ...
  },
  {
    ...
    description:
      "Soluciones especializadas para empresas que buscan fortalecer su posicionamiento, generar leads calificados y establecer relaciones comerciales duraderas.",
    features: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Ofrecemos servicios de marketing digital altamente especializados,
            diseñados para diferentes sectores y objetivos de crecimiento
            empresarial.
          </p>
        </div>
          ...
          <Tabs defaultValue="growth-marketing" className="w-full">
            ...
            {mainServices.map((service) => (
              <TabsContent key={service.id} value={service.id} className="mt-8">
                <div
                  className={`bg-gradient-to-br ${service.bgGradient} rounded-3xl p-8 lg:p-12`}
                >
                  <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                      <div className="flex items-center mb-6">
                        <div
                          className={`w-16 h-16 rounded-xl bg-gradient-to-br ${service.gradient} flex items-center justify-center mr-4`}
                        >
                    ...
                    <div>
                      ...
                      <div className="grid gap-3">
                        {service.features.map((feature, index) => (
                          <div
                            key={index}
                            className="flex items-center p-3 bg-white/60 rounded-lg backdrop-blur-sm"
                          >
        ...
        <div className="text-center mt-16 p-8 bg-gradient-to-r from-primary/5 to-tertiary/5 rounded-2xl border border-primary/10">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Creamos soluciones personalizadas que se adaptan perfectamente a las
            necesidades específicas de tu industria y objetivos de crecimiento.
          </p>
          <a
            href="#contacto"
